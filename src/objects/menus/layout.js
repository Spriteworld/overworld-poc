...
// ─── Text styles ───────────────────────────────────────────────────────────
export const TEXT_STYLE      = { fontFamily: 'monospace', fontSize: '14px', color: '#181818' };
export const TEXT_STYLE_BOLD = { fontFamily: 'monospace', fontSize: '14px', color: '#181818', fontStyle: 'bold' };
export const TEXT_STYLE_BODY = { fontFamily: 'monospace', fontSize: '13px', color: '#181818' };
export const TEXT_STYLE_HINT = { fontFamily: 'monospace', fontSize: '12px', color: '#888888' };
export const TEXT_STYLE_SM   = { fontFamily: 'monospace', fontSize: '11px', color: '#181818' };
